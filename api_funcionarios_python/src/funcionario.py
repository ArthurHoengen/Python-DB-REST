...
class Funcionario(Pessoa): # Herança
    ...
    def insert_funcionario(self):
        try:
            ...
            c.execute("insert into funcionarios (nome, sexo, data_nascimento," +
                      "qtd_dependentes, cargo, salario, id_setor) values('" + 
                      str(self.get_nome()) + "', '" + str(self.get_sexo()) + "', '" + 
                      str(self.get_data_nascimento()) + "', '" + 
                      str(self.qtd_dependentes) + "', '" + self.cargo + 
                      "', '" + str(self.salario) + "', '" + str(self.id_setor) + "')")
    ...
    def update_funcionario(self):
        try:
            ...
            c.execute("update funcionarios set nome = '" + str(self.get_nome()) +
                      "', sexo = '" + str(self.get_sexo()) + "', data_nascimento = '" +
                      str(self.get_data_nascimento()) + "', qtd_dependentes = '" + 
                      str(self.qtd_dependentes) + "', cargo = '" + self.cargo +
                      "', salario = '" + str(self.salario) + "', id_setor = '" +
                      str(self.id_setor) + "' where id_funcionario = " + 
                      str(self.id_funcionario) + " ")
    ...
    def delete_funcionario(self):
        try:
            ...
            c.execute("delete from funcionarios where id_funcionario = " +
                      str(self.id_funcionario) + " ")
    ...
    def select_funcionario(self, id_funcionario):
        try:
            ...
            c.execute("select * from funcionarios where id_funcionario = " +
                      id_funcionario + "  ")
